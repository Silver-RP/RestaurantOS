...
router.delete('/:chatId/message/:messageId', verifyChatPermission, ChatController.deleteMessage,);
router.patch('/:chatId/message/:messageId', verifyChatPermission, ChatController.editMessage,);
