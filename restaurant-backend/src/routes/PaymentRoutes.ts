...
import { vnpayReturn, momoReturn, paypalReturn, updatePaymentStatus, retryPayment } from '../controller/PaymentController';
...
router.put('/change-payment/:orderId', AuthMiddleware.verifyToken, retryPayment );
