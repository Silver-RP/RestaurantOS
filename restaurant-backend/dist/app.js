...
require("./swaggers/OrderSwagger");
require("./swaggers/FoodSwagger");
require("./swaggers/CartSwagger");
require("./swaggers/StaffSwagger");
require("./swaggers/UserSwagger");
require("./swaggers/CategorySwagger");
...
app.use('/api/profile', AuthMiddleWare_1.default.verifyToken, ProfileRoutes_1.default);
...
app.use('/api/staff', AuthMiddleWare_1.default.verifyToken, AuthMiddleWare_1.default.verifyRole(['superadmin', 'manager']), StaffRoutes_1.default);
app.use('/api/food', FoodRoutes_1.default);
app.use('/api/order', AuthMiddleWare_1.default.verifyToken, OrderRoutes_1.default);
app.use('/api/cart', AuthMiddleWare_1.default.verifyToken, CartRoutes_1.default);
app.use('/api/favorite', AuthMiddleWare_1.default.verifyToken, FavoriteRoutes_1.default);
app.use('/api/address', AuthMiddleWare_1.default.verifyToken, AddressRoutes_1.default);
app.listen(port, () => {
