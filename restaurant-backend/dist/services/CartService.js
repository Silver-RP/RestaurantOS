...
class CartService {
    static UpdateCart(id, dishId, quantity) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!mongoose_1.default.Types.ObjectId.isValid(id) || !mongoose_1.default.Types.ObjectId.isValid(dishId)) {
    ...
    static DeleteCartItem(cartId, dishId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!mongoose_1.default.Types.ObjectId.isValid(cartId) || !mongoose_1.default.Types.ObjectId.isValid(dishId)) {
                throw new Error('Invalid cartId or dishId');
            }
