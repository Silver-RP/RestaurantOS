...
const ReservationDetailContactModel_1 = __importDefault(
  require('../models/ReservationDetailContactModel'),
);
  ...
  deleteReservationDetailContact(id) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const deletedReservationDetailContact =
        yield ReservationDetailContactModel_1.default.findByIdAndDelete(id);
