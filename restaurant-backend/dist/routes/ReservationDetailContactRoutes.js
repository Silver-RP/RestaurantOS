...
const ReservationDetailContactController_1 = __importDefault(
...
router.put(
  '/update/:id',
  ReservationDetailContactController_1.default.updateReservationDetailContact,
);
router.delete(
  '/delete/:id',
  ReservationDetailContactController_1.default.deleteReservationDetailContact,
);
