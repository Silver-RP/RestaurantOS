          ...
          >
            <div className="sticky top-0 bg-bodyBackground px-6 py-4 border-b border-gray-700 z-10">
              <div className="flex justify-between items-center">
                <Dialog.Title className="text-md sm:text-lg font-bold text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-gray-300 mt-2">
                    Dự kiến nhận hàng <br /> trong 45-90 phút tính từ lúc đặt
                    hàng.
                  </p>
                </div>
              ...
              {selectedType === 'scheduled' && (
                <div className="space-y-4">
                  ...
                  <div className="text-xs text-gray-400 mt-2">
                    Lưu ý: Thời gian giao hàng từ 9:00 đến 21:00 và phải sau
                    thời điểm hiện tại ít nhất 2 giờ
                  </div>
                </div>
              )}
            </div>
            ...
            >
              ...
              <ButtonComponent className="w-1/2" onClick={handleSubmit}>
                Xác Nhận
              </ButtonComponent>
            </div>
          </Dialog.Panel>
