...
const AboutSection = () => {
  return (
    <section className="bg-bodyBackground w-full text-white py-6 md:py-16">
      <Container>
        <img
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-4xl font-restora font-thin mb-4">
            Về Chúng Tôi
          </h2>
          <h2 className="text-xs sm:text-sm md:text-sm flex justify-center items-center  font-sans font-extralight uppercase tracking-widest mb-6 text-secondaryColor">
            <FaDiamond className="inline mr-2" style={{ fontSize: '7px' }} />
            Restaurant & Bar
            <FaDiamond className="inline ml-2" style={{ fontSize: '7px' }} />
          </h2>

          <p className="mt-4 text-gray-300 max-w-xl md:max-w-2xl mx-auto text-sm sm:text-sm">
            ...
            Thực đơn phục vụ cả ngày là sự hòa quyện tinh hoa của những món ngon
            đặc trưng theo mùa.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="flex flex-col space-y-6">
            ...
            />
            <div>
              <h3 className="text-4xl md:text-6xl lg:text-7xl font-restora font-extralight text-secondaryColor">
                230+
              </h3>
              <p className="mt-2 font-restora text-lg sm:text-lg">
                Lượt Khách Hàng Ngày
              </p>
              <p className="text-gray-400 mt-4 text-sm sm:text-sm">
