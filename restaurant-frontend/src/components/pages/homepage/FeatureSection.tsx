  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-white text-left px-4 py-6">
        <h2 className="text-lg md:text-2xl lg:text-3xl font-restora font-thin transform translate-y-10 group-hover:translate-y-0 transition-all duration-500 ease-in-out">
          {title}
        </h2>
        <p className="text-xs md:text-sm mt-2 uppercase tracking-wide text-secondaryColor font-thin transform translate-y-10 group-hover:translate-y-0 transition-all duration-500 ease-in-out">
          {subtitle}
        </p>
        {buttonText && (
